...
finger1 = globals().get(finger1str, None)
finger2 = globals().get(finger2str, None)

# Calculate joint angles to reach the target
q1 = finger1.calculate(contact_1, site1_name)
q2= finger2.calculate(contact_2, site2_name)
